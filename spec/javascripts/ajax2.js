describe('$.ajax', function() {
  ...
  var onloadstart = xhr.onloadstart
  ...
  it('default options', function() {
    ...
    expect(options.start).toBe(defaultOptions.start)
  ...
  it('tracks that callback was called on successful', function() {
    ...
    expect(start.calls[0].args[0]).toBe(xhr)
