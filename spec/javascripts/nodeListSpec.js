describe('$.NodeList', function() {
  it('$.NodeList() should return an array object', function() {
    expect($.isArray($.NodeList())).toBeTruthy()
  ...
  describe('index()', function() {
    it('should be return -1', function() {
      expect($.NodeList().index()).toEqual(-1)
    })
  ...
  describe('first()', function() {
    it('should be return emtpy node list', function() {
      expect($.NodeList().first().length).toBe(0)
    })
  ...
  describe('last()', function() {
    it('should be return emtpy node list', function() {
      expect($.NodeList().last().length).toBe(0)
    })
